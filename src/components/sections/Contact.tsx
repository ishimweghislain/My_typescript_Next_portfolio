        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          >
            ...
            <div className="flex space-x-4">
              <a
                href="https://www.linkedin.com/in/ishimwe-ghislain-b26ba6288"
                target="_blank"
          ...
          >
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              {submitStatus && (
                <div
                  className={`p-4 rounded-lg ${submitStatus.success ? 'bg-green-900/50 text-green-300' : 'bg-red-900/50 text-red-300'
                    }`}
                >
