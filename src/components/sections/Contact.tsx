...
const Contact = () => {
    ...
    try {
      ...
      await emailjs.send(
        ...
        process.env.NEXT_PUBLIC_EMAILJS_TEMPLATE_ID || "",
        {
          ...
          to_name: 'ISHIMWE GHISLAIN',
          to_email: 'ishimweghislain82@gmail.com',
  ...
  const contactInfo = [
    ...
    },
    {
      ...
      title: 'Email',
      info: 'ishimweghislain82@gmail.com',
      link: 'mailto:ishimweghislain82@gmail.com',
    },
    {
      icon: (
        <svg
      ...
      title: 'Location',
      info: 'Kamonyi, Ruyenzi, Rwanda',
      link: 'https://maps.google.com/?q=Kamonyi,Rwanda',
    },
  ];
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          >
            ...
            <div className="flex space-x-4">
              <a
                href="https://linkedin.com/in/ishimweghislain"
                target="_blank"
                rel="noopener noreferrer"
              ...
              <a
                href="https://twitter.com/ishimweghislain"
                target="_blank"
                rel="noopener noreferrer"
                className="bg-gray-800 hover:bg-blue-400 text-white p-3 rounded-full transition-colors duration-300"
                aria-label="Twitter"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
              ...
              <a
                href="https://instagram.com/ghislain_ishimwe"
                target="_blank"
                rel="noopener noreferrer"
              ...
              <a
                href="https://wa.me/250781262526"
                target="_blank"
                rel="noopener noreferrer"
                className="bg-gray-800 hover:bg-green-600 text-white p-3 rounded-full transition-colors duration-300"
                aria-label="WhatsApp"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="bg-gray-800 hover:bg-gray-600 text-white p-3 rounded-full transition-colors duration-300"
                aria-label="GitHub"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div>
                ...
                <input
                  ...
                  required
                  className="w-full bg-gray-900 border border-gray-700 rounded-lg py-3 px-4 text-white focus:outline-none focus:ring-2 focus:ring-blue-500"
                />
              </div>
              <div>
